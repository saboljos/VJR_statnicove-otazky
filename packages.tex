...
\usepackage{geometry} % využití A4 stránky a nastavení okrajů (u vazby bude širší) [a4paper, hmarginratio=3:2]
\usepackage{upgreek}
...
\usepackage{listings}  % balíček vhodný pro ukázky zdrojového kódu
...
% Proper bibliography
\usepackage[style=iso-numeric, backend=bibtex, language=czech]{biblatex}
...
%% vlastní
\usepackage{setspace}   % pro řádkování
\usepackage{adjustbox}  % pro rotaci s tabulkami
\usepackage{siunitx}    % SI unitx
\usepackage{booktabs,threeparttable}   % tabulky
